...
std::deque<IDepo::pointer> test_depos(const std::vector<IDepo::pointer>& depos, std::string tn="VagabondX");
...
void test_tracks(std::string tn="VagabondX");
...
void test_time(std::string tn="VagabondX");
...
void test_order(std::string tn="VagabondX");
...
int main(int argc, char* argv[])
{
    ...
    {
        auto icfg = Factory::lookup<IConfigurable>("VagabondX");
        auto cfg = icfg->default_configuration();
        //cerr << cfg << endl;
    ...
    test_tracks("VagabondX");
    test_time("VagabondX");
    test_order("VagabondX");

    IDepo::vector drifted = test_drifted("VagabondX");
